...
```
┌──────────────────────────────────────────────────────────────┐
│  guest@github:~$ fastfetch                                    │
└──────────────────────────────────────────────────────────────┘

       ▄▄▄▄▄▄▄▄▄▄▄            OS: Human.exe (Full-Stack Build)
     ▄█████████████▄          Host: Web Developer
    ██████▀▀▀▀▀██████         Kernel: Coffee 6.9-stable
   █████    ▄▄    █████       Uptime: 3+ years coding
   ████    █████   ████       Packages: node, php, python
   █████    ▀▀    █████       Shell: zsh
...
> Web developer yang suka membangun aplikasi dari ujung ke ujung — dari desain database
> sampai antarmuka yang rapi di browser. Terbiasa kerja di terminal, ngoprek stack baru,
> dan bikin sesuatu yang *actually ships*.

<br>

```bash
guest@github:~$ ls tech-stack/
```
